            ...
            <div className='director-desk'>
                ...
                <div className='director-content'>
                    ...
                    <div className='director-message'>
                        ...
                        <p className='director-name'>- N S Raghuvansi chutiya</p>
                    </div>
                </div>
            </div>
            <div className='tpo-desk'>
                <h2><span>TPO's message</span></h2>
                <div className='tpo-content'>
                    <div className='tpo-image'>
                        <img src='images/directorImage.png' alt="TPO's image" ></img>
                    </div>
                    <div className='tpo-message'>
                        ...
                        <p className='tpo-name'>- Ajay Srivastav chutiya</p>
                    </div>
                </div>
            </div>
        </div>
